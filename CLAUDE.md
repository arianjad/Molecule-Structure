...
Git working copy (day-to-day): **`~/Code-Local/Molecule-Structure`** — clone of `arianjad/Molecule-Structure`; GitHub is the source of truth. Do all edits and git here.
